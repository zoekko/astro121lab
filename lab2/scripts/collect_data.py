...
our_data = our_sdr.capture_data(nsamples=2048, nblocks=512)
np.save(save_dir+'s_cal_'+str(int(samp_freq/1000))+ take, our_data)
# np.save(save_dir+'s_cold_'+str(int(samp_freq/1000))+ take, our_data)